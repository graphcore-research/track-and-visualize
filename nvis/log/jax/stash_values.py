...
def exp_histogram(tensor: jax.Array, min_exp=-16, max_exp=16) -> Dict[str,jax.Array]:
    """
    Gets the histogram of the exponents for the values in the jax.Array, any thing over/under max_exp/min_exp will be set to +/-inf
    ...
    Returns:
        Dict : A dictionary containing the lists for histogram counts & bin edges
