    ...
    with track(
        ...
        while True:
            ...
            if iter_num > max_iters:
                logging.warning(f'Total Time = {time.time() - time_start}')
                break
                

    # numerics_df = pd.DataFrame(numerics_data)
    # numerics_df.columns = pd.MultiIndex.from_tuples(numerics_df.columns)
    # numerics_df.to_pickle("numerics_df.pkl")
